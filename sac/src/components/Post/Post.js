                ...
                <div className='post-info'>
                    <div className='post-user-image'>
                        {imageUrl ? (
                            ...
                            <img src={userDefaultImage} alt='User Default Image' />
                        )}
                    </div>
            ...
            <div className='post-footer'>
                <div className='post-footer-buttons'>
                    <button className='post-comment-button'>
                        <img src={commentImage} alt='User Image' />
                        <div className='footer-text'>{commentCount}</div>
                    </button>
                    <button className='post-comment-button'>
                        <img src={heartTrueImage} alt='User Image' />
                        <div className='footer-text'>{heartCount}</div>
                    </button>
                    <button className='post-comment-button'>
                        <img src={shareImage} alt='User Image' />
                    </button>
                    <button className='post-comment-button'>
                        <img src={viewsImage} alt='User Image' />
